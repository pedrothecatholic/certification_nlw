package com.pedrothecatholic.certification_nlw.modules.students.repositories;
...
@Repository
public interface CertificationStudentRespository extends JpaRepository<CertificationStudentEntity, UUID> {
